...
class _UserManagementPageState extends State<UserManagementPage> {
  ...
  static const Map<String, List<Map<String, String>>> _permissionGroups = {
    ...
    'المالية والتقارير (Financials)': [
      ...
      {'key': 'financial_reports', 'label': 'التقارير المالية التفصيلية (Financial Reports)'},
    ],
    'الموارد البشرية والدوام (HR & Operations)': [
      ...
      {'key': 'shifts_monitoring', 'label': 'مراقبة ورديات الفريق (Shifts Monitoring)'},
      {'key': 'team_monitoring', 'label': 'مراقبة الموظفين (Team Monitoring)'},
    ],
    'أدوات وإعدادات النظام (System & Tools)': [
      ...
      {'key': 'contract_closing_settings', 'label': 'سياسة إغلاق العقود (Contract Closing Settings)'},
      {'key': 'admin_monitoring', 'label': 'التنبيهات وسجل التدقيق (Admin Monitoring)'},
      {'key': 'notifications', 'label': 'نظام التنبيهات (Notifications)'},
      {'key': 'audit_logs', 'label': 'سجل التدقيق المالي الكامل (Financial Audit Logs)'},
      {'key': 'depreciation_logs', 'label': 'سجل إهلاك الأصول (Depreciation Logs)'},
      {'key': 'system_health', 'label': 'حالة النظام والصيانة (System Health)'},
