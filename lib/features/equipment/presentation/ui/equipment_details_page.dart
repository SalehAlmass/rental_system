                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Divider(),
                      _buildDetailItem('السعر اليومي', '${equipment.dailyRate.toStringAsFixed(0)} ر.ي'),
                      const Divider(),
                      _buildDetailItem('نسبة الإهلاك', '${equipment.depreciationRate.toStringAsFixed(0)} %'),
                      const Divider(),
                      _buildDetailItem('سعر الشراء', '${equipment.purchasePrice.toStringAsFixed(2)} ر.ي'),
                      const Divider(),
                      _buildDetailItem('القيمة المتبقية', '${equipment.salvageValue.toStringAsFixed(2)} ر.ي'),
                      const Divider(),
                      ...
                      const Divider(),
                      _buildDetailItem('الإهلاك الشهري', '${equipment.depreciationMonthly.toStringAsFixed(2)} ر.ي'),
                      const Divider(),
                      _buildDetailItem('الإهلاك التراكمي', '${equipment.depreciationAccumulated.toStringAsFixed(2)} ر.ي'),
                      const Divider(),
                      _buildDetailItem('القيمة الدفترية الحالية', '${equipment.bookValue.toStringAsFixed(2)} ر.ي'),
                      const Divider(),
                      _buildDetailItem('أيام الاستخدام المقدرة', '${equipment.estimatedUsageDays} يوم'),
                      const Divider(),
                      _buildDetailItem('الإهلاك التشغيلي/يوم', '${equipment.operationalDepreciationPerDay.toStringAsFixed(2)} ر.ي'),
                      const Divider(),
                      _buildDetailItem('الإهلاك التشغيلي التراكمي', '${equipment.operationalDepreciationAccumulated.toStringAsFixed(2)} ر.ي'),
                      const Divider(),
                      _buildDetailItem(
                        'الحالة النشاطية', 
