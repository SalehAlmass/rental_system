                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const Divider(),
                      _buildDetailItem('سعر الشراء', '${equipment.purchasePrice.round()} ر.ي'),
                      const Divider(),
                      _buildDetailItem('القيمة المتبقية', '${equipment.salvageValue.round()} ر.ي'),
                      const Divider(),
                      ...
                      const Divider(),
                      _buildDetailItem('الإهلاك الشهري', '${equipment.depreciationMonthly.round()} ر.ي'),
                      const Divider(),
                      _buildDetailItem('الإهلاك التراكمي', '${equipment.depreciationAccumulated.round()} ر.ي'),
                      const Divider(),
                      ...
                      const Divider(),
                      _buildDetailItem('الإهلاك التشغيلي التراكمي', '${equipment.operationalDepreciationAccumulated.round()} ر.ي'),
                      const Divider(),
                      _buildDetailItem(
                        'الحالة النشاطية', 
